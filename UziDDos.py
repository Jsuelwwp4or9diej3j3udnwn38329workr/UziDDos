...
by: b i y i v i   
    ...
    def chech_con():
        try:
            ...
            print(Fore.RED+Style.BRIGHT+'Silahkan cek koneksi internet anda...'+Fore.RESET)
            exit()
    ...
    try:
        while True:
            ...
            if opt=='1':
                ...
                time.sleep(1)
                print(Fore.RED+"Sampai jumpa"+Fore.RESET)
                exit()
            else:
        ...
        print(Fore.RED+"¡ada yang salahl!")
    ...
    try:
        while True:
            ...
            print(color_random+"Send To Ip %s Packet %s Port:%s" % (sent, ip, port))
            if port==65534:
                port=1
            elif port==1900:
                port=1901
